                ...
                <div class="hero-slider__slide"
                    ...
                    <div class="hero-slider__interior container">
                        <div class="hero-slider__overlay">
                            ...
                            <p class="t-center no-margin"><a href="blog#one" class="btn btn--blue">Learn more</a></p>
                        </div>
                    </div>
                </div>
                <div class="hero-slider__slide"
                    ...
                    <div class="hero-slider__interior container">
                        <div class="hero-slider__overlay">
                            ...
                            <p class="t-center no-margin"><a href="blog#two" class="btn btn--blue">Learn more</a></p>
                        </div>
                    </div>
                </div>
                <div class="hero-slider__slide"
                    ...
                    <div class="hero-slider__interior container">
                        <div class="hero-slider__overlay">
                            ...
                            <p class="t-center no-margin"><a href="blog#three" class="btn btn--blue">Learn more</a></p>
                        </div>
                    </div>
                </div>
            </div>
